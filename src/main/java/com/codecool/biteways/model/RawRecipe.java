...
public class RawRecipe {
    ...
    @Pattern(regexp = "^[a-zA-Z0-9\\s\\-,.\\n\\r%<>°éáíóöőüúÉÁÍÓÖŐÜÚ]*$", message = "Please enter instructions that only contain letters, numbers, hyphens, and spaces.")
    ...
    @Pattern(regexp = "^[a-zA-Z0-9\\s\\-,.\\r\\néáíóöőüúÉÁÍÓÖŐÜÚ]*$", message = "Please enter ingredients that only contain letters, numbers, hyphens, spaces, and line breaks.")
